...
import {confirmAccountText} from '../../utils/Apptext';
      ...
      <KeyboardAvoidingView
        ...
        <TouchableWithoutFeedback onPress={() => Keyboard.dismiss()}>
          <View style={styles.inner}>
            ...
            <View>
              <CustomText
                text={confirmAccountText.head2}
                style={styles.heading2}
              />
              <View style={styles.descContainer}>
                <CustomText
                  text={confirmAccountText.descText}
            ...
            <View style={{...styles.descContainer, justifyContent: 'center',}}>
              <CustomText
                text={confirmAccountText.bottomdescText}
                style={styles.descTextSize}
              />
              <TouchableOpacity
                onPress={() => {
                ...
                <CustomText
                  ...
                  text={confirmAccountText.loginLinkText}
                />
              </TouchableOpacity>
            </View>
          </View>
